...
# ASCII shield derived from assets/logo/aegis-shield.svg
echo -e "${BOLD}${BANNER_COLOR}         .-~~~~~~~~~~~~~-.           ${NC}"
echo -e "${BOLD}${BANNER_COLOR}        /   •  A  E  G  •   \\          ${NC}"
echo -e "${BOLD}${BANNER_COLOR}       |   •     ╱╲     •   |         ${NC}"
echo -e "${BOLD}${BANNER_COLOR}       |  •     ╱──╲     •  |         ${NC}"
echo -e "${BOLD}${BANNER_COLOR}        \\  •   ╱    ╲   •  /          ${NC}"
echo -e "${BOLD}${BANNER_COLOR}         \\    ───────    /           ${NC}"
...
echo -e "${BOLD}${BANNER_COLOR}            \\.       ./              ${NC}"
echo -e "${BOLD}${BANNER_COLOR}             \\.     ./               ${NC}"
echo -e "${BOLD}${BANNER_COLOR}              \\.___./                ${NC}"
echo ""
...
# ASCII shield derived from assets/logo/aegis-shield.svg — green = success
echo -e "${BOLD}${GREEN}         .-~~~~~~~~~~~~~-.           ${NC}"
echo -e "${BOLD}${GREEN}        /   •  A  E  G  •   \\          ${NC}"
echo -e "${BOLD}${GREEN}       |   •     ╱╲     •   |         ${NC}"
echo -e "${BOLD}${GREEN}       |  •     ╱──╲     •  |         ${NC}"
echo -e "${BOLD}${GREEN}        \\  •   ╱    ╲   •  /          ${NC}"
echo -e "${BOLD}${GREEN}         \\    ───────    /           ${NC}"
...
echo "  ├── CLAUDE_agents.md       # 10 agents (v9 consolidated, was 13)"
...
echo "  ├── tools/                 # 20+ helper scripts (aegis-*.sh)"
echo "  ├── skills/                # Skill definitions"
echo "  └── .claude/               # Claude CLI config"
echo "      ├── agents/            # 10 agent prompts + _archived/"
echo "      ├── commands/          # 29 slash commands"
echo "      ├── hooks/             # 9 hooks (guard-*, session-start, etc.)"
